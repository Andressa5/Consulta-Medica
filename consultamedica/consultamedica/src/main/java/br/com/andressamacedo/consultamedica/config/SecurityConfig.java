package br.com.andressamacedo.consultamedica.config;
...
public class SecurityConfig {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                .withUser("ANDRESSA").password(passwordEncoder.encode("123456")).roles("ADMIN")
                .and()
                .withUser("NICOLE").password(passwordEncoder.encode("131015")).roles("PACIENTE")
                .and()
                .withUser("MACEDO").password(passwordEncoder.encode("131313")).roles("SECRETARIO");
